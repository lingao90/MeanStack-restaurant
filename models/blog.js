...
module.exports.editBlog = function(blog, callback) { //console.log(Blog.findOneAndUpdate({ _id: blog.id}, { $set: { heading: blog.heading, tags: blog.tags, body: blog.body, modifiedDate: blog.modifiedDate }}));
