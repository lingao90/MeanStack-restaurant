...
router.post('/', (req, res, next) => {//console.log(req);return;
...
router.post('/countBlogs', (req, res, next) => {//console.log(req);return;
  const blogObj = {
    tag: req.body.tag,
...
router.post('/addBlog', passport.authenticate('jwt', { session: false }), (req, res, next) => {  //console.log();return;
