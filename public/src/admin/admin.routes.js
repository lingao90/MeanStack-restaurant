...
function config($stateProvider, $httpProvider) {
  ...
  $stateProvider
    ...
    .state('admin.auth.category.add', { 
      url: "/admin-auth/category-add",
      templateUrl: 'src/admin/category/category-add.html',
    ...
    .state('admin.auth.menuitemadd', { 
      url: "/admin-auth/menuitem-add",
      templateUrl: 'src/admin/menu-item/menuitem-add.html',
